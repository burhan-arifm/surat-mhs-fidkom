                ...
                <div class="row my-3">
                    ...
                    <div class="col-10">
                        ...
                        <div class="row">
                            <p>
                                Kepada Yth.<br>
                                <b>{{ $surat->izin_observasi->instansi_penerima }}</b><br>
                                {{ $surat->izin_observasi->alamat_instansi }}
                            </p>
                        </div>
                        ...
                        <div class="row mt-1">
                            ...
                            <table class="table table-sm table-borderless" style="margin-left: 2.2em;">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td>{{ $surat->izin_observasi->dosen_pembimbing }}</td>
                                    </tr>
                                </tbody>
                            </table>
                            <!-- end of Isi Surat -->
                            ...
                            <p class="text-justify mini-margin">
                                untuk mengadakan Observasi Lapangan / Konsultasi dalam rangka persiapan  penyusunan skripsi, dengan judul / topik / masalah {{ $surat->izin_observasi->topik_penelitian }}.
                            </p>
