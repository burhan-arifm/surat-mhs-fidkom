    ...
    <div class="container">
        ...
        <div class="mt-4 px-4">
                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="row">Rektor</div>
                        <div class="row">Dekan,</div>
                        <div class="row"><br></div>
                        <div class="row"><br></div>
                        <div class="row"><br></div>
                        <div class="row"><br></div>
                        <div class="row"><b>Dr. H. Ahmad Sarbini, M.Ag.</b></div>
                        <div class="row">NIP.196801121993031003</div>
                    </div>
                </div>
                ...
                <div class="row mt-5">
                    <p>
                        Tembusan:<br>
                        Yth. Rektor Universitas Islam Negeri Sunan Gunung Djati Bandung (sebagai laporan)
                    </p>
                </div>
